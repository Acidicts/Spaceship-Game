...
class Game:
    def __init__(self):
        ...
        self.font = pygame.font.Font("images/Oxanium-Bold.ttf", 36)
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_SPACE and not self.laser:
                        ...
                        self.mixer.music.load('audio/laser.wav')
                        self.mixer.music.play(1)
            ...
            for meteor in self.meteors:
                ...
                if meteor.rect.colliderect(self.player.rect):
                    self.mixer.music.load('audio/explosion.wav')
                ...
                if self.laser:
                    if self.laser.rect.colliderect(meteor.rect):
                        self.mixer.music.load('audio/damage.ogg')
                        self.mixer.music.play(1)
